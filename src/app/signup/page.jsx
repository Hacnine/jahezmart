...
const SignUp = () => {
 ...
 <div className="max-w-lg mx-auto shadow-xl px-6 py-7 rounded overflow-hidden text-sm ">
     <h2 className="text-2xl uppercase font-base mb-1 text-center text-orangeRed">Sign Up</h2>
     ...
     <form className="pt-8" action="">
      <div className="space-y-6">
         <div>
             ...
             <input type="text" id="name" className="input placeholder:text-xs " placeholder="Enter your name"/>
         </div>
         
         <div>
             <label htmlFor="phone" className="text-gray-600 mb-2 block"> Phone Number</label>
             <input type="number" id="phone" className="input placeholder:text-xs" placeholder="Enter your phone number"/>
         </div>

         <div>
             <label htmlFor="email" className="text-gray-600 mb-2 block"> Email Address</label>
             <input type="email" id="email" className="input placeholder:text-xs " placeholder="Enter your name"/>
         </div>

            <div>
             <label htmlFor="password" className="text-gray-600 mb-2 block"> Password</label>
             <input type="email" className="input placeholder:text-xs " id="password" placeholder="Enter your password"/>
            </div>

            <div>
             <label htmlFor="re-password" className="text-gray-600 mb-2 block"> Re-Enter Password</label>
             <input type="email" className="input placeholder:text-xs " id="password" placeholder="Renter your password"/>
            </div>
     ...
     <p className="mt-4 text-gray-600 text-center">Have an Account?
       <Link href="/signin" className="text-red-600">{" "}  Sign In Now!</Link>
     </p>
 </div>
</div>
      </>
